...
<template>
  <div class="help-support">
    ...
    <el-card class="purchase-request-section">
      ...
      <el-table :data="purchaseRequests" style="width: 100%" v-if="isLoggedIn">
    ...
    fetchMyRequest() {
      if(auth.isLoggedIn) {
        ...
        axios({
          ...
          this.purchaseRequests = response.data.data.records; // Assuming the returned data is an array of books
